        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-orange-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <Input id="email" type="email" placeholder="john@example.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="mt-2 rounded-xl border-gray-200 focus:border-orange-500" data-testid="register-email-input" />
            </div>
